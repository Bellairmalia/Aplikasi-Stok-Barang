...
Public Class rptPenyesuaian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STOK_BARANG_KOPERASI.rptPenyesuaian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPenyesuaian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPenyesuaian = New rptPenyesuaian()
        rpt.Site = Me.Site
        Return rpt
    End Function
