...
Public Class rptStokBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STOK_BARANG_KOPERASI.rptStokBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStokBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStokBarang = New rptStokBarang()
        rpt.Site = Me.Site
        Return rpt
    End Function
