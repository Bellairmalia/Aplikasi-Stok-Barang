...
Public Class rptBarangKeluar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STOK_BARANG_KOPERASI.rptBarangKeluar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Tampiltanggal() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptBarangKeluar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarangKeluar = New rptBarangKeluar()
        rpt.Site = Me.Site
        Return rpt
    End Function
